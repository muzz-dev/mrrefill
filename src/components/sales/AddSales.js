...
function AddSales() {
    ...
    const addSales = async () => {
        ...
        await axios.post(`${BASE_URL}/Sales`, objSales).then((response) => {
            ...
            const objTransaction = {
                ...
                salesReturnId: "",
                type: "Credit",
                transactionDate: response.data.salesDate,
            ...
            axios.post(`${BASE_URL}/Transaction`, objTransaction).then((transationResponse) => {
                ...
                products.map(async (product) => {
                    ...
                    await axios.get(`${BASE_URL}/Product/${product.productId}`).then((productResponse) => {
                        ...
                        objSales.salesPrice = subtotal;
                        console.log(subtotal);
                        total = total + subtotal;
                    })
    
                    await axios.post(`${BASE_URL}/SalesDetail`, objSales).then((purchaseDetailres) => {
                        ...
                        axios.put(`${BASE_URL}/Sales/${response.data.salesId}`, EditSales).then((EditSales) => {
                            console.log("edit purchsase", EditSales);
                        })
    ...
    return (
        <>
            <Helmet>
                <title>Mr.Refill | Add Sales</title>
            </Helmet>
            <Header />
            <Sidebar />
                            ...
                            <div className='col-lg-6'>
                                <div className="card">
                                    <div className="card-body">
                                        <h4 className="card-title mb-4">Add Sales</h4>
                                        <form >
                                            ...
                                            <div className="form-group row justify-content-end">
                                                <div className="col-sm-9">
                                                    <div>
                                                        <button type='button' onClick={addSales} className="btn btn-primary w-md mr-3" style={{ alignContent: 'center' }}>Add Sales</button>

...
function Company() {
    ...
    const [allCompany, getCompany] = useState([]);
    ...
    const deleteCompany = (id) => {
        axios.delete(`${BASE_URL}/Company/${id}`).then((res) => {
            setShow(false);
            console.log(res);
        })
                                ...
                                <div className="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div className="page-title-right">
                                        <ol className="breadcrumb m-0">
                                            <li className="breadcrumb-item"><a href="javascript: void(0);">Company</a></li>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className='row'>
                                            <div className='col-lg-6'>
                                                <h4 className="card-title text-left">Company</h4>
                                            </div>
                                            <div className='col-lg-6'>
                                                <div className="text-right card-title">
                                                    <NavLink to="/AddCompany" className="btn btn-primary" tabIndex="-1" role="button" aria-disabled="true">Add Company</NavLink>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            : (
                                                <>
                                                    ...
                                                    <table id="datatable-buttons" className="table table-bordered dt-responsive nowrap" style={{ bordercollapse: "collapse", borderspacing: "0", width: "100%" }}>
                                                        ...
                                                        <tbody>
                                                            {
                                                                allCompany.sort((a,b)=>a.companyName > b.companyName ? 1 : -1).filter(val => {
                                                                    if (searchTerm === '') {
                                                                        return val;
                                                                    } else if (
                                                                        val.companyName.toLowerCase().includes(searchTerm.toLowerCase()) || val.isActive.toLowerCase().includes(searchTerm.toLowerCase())
                                                                    ) {
                                                                        return val;
                                                                    }
                                                                }).map((obj, i) => {
                                                                    return (
                                                                        <tr key={i}>
                                                                            ...
                                                                            <td>{obj.isActive}</td>
                                                                            <td>
                                                                                <NavLink to={`/EditCompany/${obj.companyId}`} className="btn btn-outline-primary btn btn-sm waves-effect waves-light" tabIndex="-1" role="button" aria-disabled="true" >Edit</NavLink>&nbsp;
                                                                                <button type="button" onClick={() => handleShow(obj.companyId)} className="btn btn-outline-danger btn btn-sm waves-effect waves-light open-dialog" >Delete</button>
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    <Modal.Footer>
                                                                                        ...
                                                                                        <Button variant="primary" onClick={() => deleteCompany(deleteId)}>
